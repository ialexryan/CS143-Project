...
For this test case, TCP simulation results show that the average queue length is 59 packets for Link L0, but this is different compared to the expected length of 50 packets
